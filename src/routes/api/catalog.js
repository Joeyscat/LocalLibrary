...
// 添加新的藏书
router.post('/book', validateRequest.book_create_validate, book_controller.create)

// 删除藏书
router.delete('/book/:id', book_controller.delete)

// 更新藏书
router.put('/book', validateRequest.book_update_validate, book_controller.update)
...
// 添加新作者
router.post('/author', validateRequest.author_create_validate, author_controller.create)

// 删除作者
router.delete('/author/:id', author_controller.delete)

// 更新作者
router.put('/author', validateRequest.author_update_validate, author_controller.update)
